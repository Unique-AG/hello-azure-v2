...
echo "   - Source: These attributes are hardcoded in the azure-postgresql module (v3.1.0)"
echo "   - Why: The module enforces Azure security best practices for Key Vault secrets:"
echo "     * content_type helps identify the secret type"
echo "     * expiration_date is required by Azure security policies (CIS benchmark)"
echo "   - Impact: Non-breaking metadata enhancements. Secret VALUES are NOT changed."
echo "   - Action: Safe to apply. Cannot be avoided without forking the module."
echo ""
