...
module "application_gateway" {
  source        = "github.com/Unique-AG/terraform-modules.git//modules/azure-application-gateway?depth=1&ref=63d79a11a7b1fe236279410fa1897d342c0293aa" # azure-application-gateway-4.4.1
